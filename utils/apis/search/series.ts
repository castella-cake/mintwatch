...
export async function getFastSeriesSearch(keyword: string, options: VideoSearchQuery = {}) {
    return await initialResponse(`/series_search/${encodeURIComponent(keyword)}`, getSeriesSearch, keyword, options)
}
