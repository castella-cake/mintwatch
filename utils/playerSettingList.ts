...
export type PlayerSettingList = { [key: string]: { [key: string]: PlayerSetting } }
...
export function toFlatPlayerSettings(playerSettingList: PlayerSettingList): { [key: string]: PlayerSetting } {
    return Object.keys(playerSettingList).reduce((prev, current) => ({...prev, ...playerSettingList[current]}), {})
}