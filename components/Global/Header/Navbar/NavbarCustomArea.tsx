...
export default function NavbarCustomArea({ isEditMode, setIsEditMode }: { isEditMode: boolean, setIsEditMode: Dispatch<SetStateAction<boolean>> }) {
    ...
    return <div className="navbar-custom-area" ref={setNodeRef} data-is-editmode={isEditMode}>
        ...
        {isEditMode && <div className="navbar-custom-area-editmode-tips">
            カスタムエリアを編集中です。サイドバーから好きなアイテムをドラッグして追加できます。<br/>
