...
export function Title({ videoInfo }: { videoInfo: VideoDataRootObject }) {
    ...
    return <div className="videotitle-container">
        ...
        <div className="videostats">
            <span className="videostats-item">{new Date(videoInfoResponse.video.registeredAt).toLocaleString('ja-JP')}</span>
            <span className="videostats-item"><IconPlayerPlayFilled/>{readableInt(videoInfoResponse.video.count.view)}</span>
            <span className="videostats-item"><IconMessageFilled/>{readableInt(videoInfoResponse.video.count.comment)}</span>
            <span className="videostats-item"><IconFolderFilled/>{readableInt(videoInfoResponse.video.count.mylist)}</span>
        </div>
    </div>
}
