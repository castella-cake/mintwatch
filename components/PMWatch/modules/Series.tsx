    ...
    return <div className="seriesinfo-container" id="pmw-seriesinfo">
        {seriesData ? <div className="seriesinfo-content">
            <div className="seriesinfo-thumbnail-wrapper">
                <img src={seriesData.thumbnailUrl} alt={`${seriesData.title} のサムネイル`} className="seriesinfo-thumbnail"/>
            </div>
            ...
            <div className="seriesinfo-first">
                {seriesData.video.first ? <SeriesVideoCard seriesVideoItem={seriesData.video.first} playlistString={playlist} transitionId={seriesData.id} type="first"/> : <div className="seriesinfo-no-video">最初の動画はありません</div>}
            </div>
            <div className="seriesinfo-episodes">
                {seriesData.video.prev ? <SeriesVideoCard seriesVideoItem={seriesData.video.prev} playlistString={playlist} transitionId={seriesData.id} /> : <div className="seriesinfo-no-video">前の動画はありません</div>}
                {seriesData.video.next ? <SeriesVideoCard seriesVideoItem={seriesData.video.next} playlistString={playlist} transitionId={seriesData.id} type={"next"}/> : <div className="seriesinfo-no-video">次の動画はありません</div>}
            </div>
        </div> : 
