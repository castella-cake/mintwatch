        ...
        <StorageProvider>
            <div className="container">
                ...
                <div id="info-area" className="includelinks">
                    <div className="hint">
                        <br />
                        MintWatch を一時的に無効にする場合は、ヘッダーにあるドアのアイコンをクリックします。
                        <br />
                        再度オンにするまで無効にしたい場合は、拡張機能自体を無効化してください。
                        <br />
                        設定は自動保存されます。保存した設定を反映させるには、リロードする必要があります。
                        <br />
                    ...
                    <div className="links" style={{ marginTop: "1em" }}>
                        <span>MintWatch</span>
                        <a href="https://github.com/castella-cake/mintwatch" target="_blank" rel="noopener noreferrer"><IconBrandGithubFilled /></a>
                        <a href="https://discord.com/invite/GNDtKuu5Rb" target="_blank" rel="noopener noreferrer" style={{ marginRight: 4 }}><IconBrandDiscordFilled /></a>
                    </div>
                    <div className="links">
                        ...
                        <a href="https://x.com/CYaki_xcf" target="_blank" rel="noopener noreferrer">X(Twitter)</a>
                        {" "}
                        <br />
                    </div>
