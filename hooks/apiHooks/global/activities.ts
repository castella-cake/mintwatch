...
export function useActivitiesQuery(context: "header_timeline" | "my_timeline" | `user_timeline_${number}` | "top_follow" = "header_timeline", type: "publish" | "video" | "live" | "all" = "publish", userId?: number, isActorsQuery = false) {
